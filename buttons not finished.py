...
pause_box = pygame.Rect(0,0, globals.WIDTH, globals.HEIGHT)
info_box = pygame.Rect(globals.WIDTH - 800, globals.HEIGHT-800, 500, 300)
...
lower_speed_rect.center = (globals.WIDTH//2 + 500, globals.HEIGHT//16 * 9)

hitbox_display_rect = pygame.Rect(0,255, 300, 30)
hitbox_display_rect.center = (globals.WIDTH//2 + 500, globals.HEIGHT//16 * 10)
